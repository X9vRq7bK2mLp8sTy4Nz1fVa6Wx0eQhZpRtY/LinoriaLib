...
function Library:MakeDraggable(Instance, Cutoff)
    ...
    Instance.InputBegan:Connect(function(input)
        if (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch) and not Library:MouseIsOverOpenedFrame() then
            local objPos = input.Position - Instance.AbsolutePosition;
            if objPos.Y > Cutoff then return end;
...
function Funcs:AddColorPicker(Idx, Info)
    ...
    SatVibMap.InputBegan:Connect(function(input)
        Library:TouchFeedback(SatVibMap);
        if (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch) then
            while InputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1) or UserInputService:IsTouching(Enum.UserInputType.Touch) do
                local MinX = SatVibMap.AbsolutePosition.X;
                local MaxX = MinX + SatVibMap.AbsoluteSize.X;
                local MouseX = math.clamp(MouseLocation().X, MinX, MaxX);

                local MinY = SatVibMap.AbsolutePosition.Y;
                local MaxY = MinY + SatVibMap.AbsoluteSize.Y;
                local MouseY = math.clamp(MouseLocation().Y, MinY, MaxY);
    ...
    HueSelectorInner.InputBegan:Connect(function(input)
        Library:TouchFeedback(HueSelectorInner);
        if (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch) then
            while InputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1) or UserInputService:IsTouching(Enum.UserInputType.Touch) do
    ...
    DisplayFrame.InputBegan:Connect(function(input)
        Library:TouchFeedback(DisplayFrame);
        if (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch) and not Library:MouseIsOverOpenedFrame() then
    ...
    if TransparencyBoxInner then
        TransparencyBoxInner.InputBegan:Connect(function(input)
            Library:TouchFeedback(TransparencyBoxInner);
            if (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch) then
                while InputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1) or UserInputService:IsTouching(Enum.UserInputType.Touch) do
    ...
    Library:GiveSignal(InputService.InputBegan:Connect(function(input)
        ...
        if (input.UserInputType == Enum.UserInputType.MouseButton2 or input.UserInputType == Enum.UserInputType.Touch) and ContextMenu.Container.Visible then
...
function Funcs:AddKeyPicker(Idx, Info)
    ...
    -- Mobile: Disable key picking entirely (long-press fallback)
    if Library.IsMobile then
        ...
        -- Long-press to toggle on mobile
    ...
    -- Desktop-only: Original code with Touch added to all InputBegan checks and MouseLocation
    local PickOuter = Library:Create('Frame', {
        BackgroundColor3 = Color3.new(0, 0, 0);
        BorderColor3 = Color3.new(0, 0, 0);
        Size = UDim2.new(0, 28, 0, 15);
        ...
        if (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch) and not Library:MouseIsOverOpenedFrame() then
            ...
            Event = InputService.InputBegan:Connect(function(input)
                ...
                elseif input.UserInputType == Enum.UserInputType.Touch then
                    Key = 'Touch';  -- Fallback for mobile, but since mobile branch above, this won't hit
                end;
...
function Funcs:AddButton(...)
    ...
    local function InitEvents(Button)
        ...
        Button.Outer.InputBegan:Connect(function(input)
            Library:TouchFeedback(Button.Outer);
...
function Funcs:AddDropdown(Idx, Info)
    ...
    local MAX_DROPDOWN_ITEMS = Library.IsMobile and 5 or 8;  -- Smaller on mobile
    ...
    local Scrolling = Library:Create('ScrollingFrame', {
        ...
        ScrollingEnabled = true,  -- Explicit for touch
    ...
    function Dropdown:BuildDropdownList()
        ...
        for Idx, Value in next, Values do
            ...
            ButtonLabel.InputBegan:Connect(function(input)
                Library:TouchFeedback(ButtonLabel);
                if (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch) then
    ...
    DropdownOuter.InputBegan:Connect(function(input)
        Library:TouchFeedback(DropdownOuter);
        if (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch) and not Library:MouseIsOverOpenedFrame() then
